                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'LOGIN_ESQUECEU_A_SENHA_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_alert_dialog');
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'LOGIN_PAGE_PAGE_CRIAR_CONTA_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Button_auth');
                                                          GoRouter.of(context)
                                                              .prepareAuthEvent();
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: CachedNetworkImageProvider(
                          'https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Arraial_do_cabo-_Rj.jpg/640px-Arraial_do_cabo-_Rj.jpg',
                        ),
                      ),
